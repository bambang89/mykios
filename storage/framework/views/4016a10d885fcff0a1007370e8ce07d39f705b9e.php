...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.utils.link','data' => ['href' => route('frontend.index'),'text' => appName(),'class' => 'navbar-brand']]); ?>
<?php $component->withName('utils.link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('frontend.index')),'text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(appName()),'class' => 'navbar-brand']); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/mykios/resources/views/frontend/includes/nav.blade.php ENDPATH**/ ?>