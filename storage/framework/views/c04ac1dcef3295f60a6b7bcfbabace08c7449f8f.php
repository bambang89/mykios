...
} elseif ($_instance->childHasBeenRendered('GivtVYg')) {
    $componentId = $_instance->getRenderedChildComponentId('GivtVYg');
    $componentTag = $_instance->getRenderedChildComponentTagName('GivtVYg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GivtVYg');
} else {
    $response = \Livewire\Livewire::mount('backend.users-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('GivtVYg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
         <?php $__env->endSlot(); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/mykios/resources/views/backend/auth/user/index.blade.php ENDPATH**/ ?>