    ...
    <?php endif; ?>
     ...
     <?php $__env->slot('body', null, []); ?> 
        ...
        <?php $__empty_1 = true; $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'livewire-tables::bootstrap-4.components.table.row','data' => ['wire:loading.class.delay' => 'text-muted','wire:key' => 'table-row-'.e(md5(mt_rand())).'-'.e($row->{$this->parseField($primaryKey)}).'','wire:sortable.item' => ''.e($row->{$primaryKey}).'','reordering' => $reordering,'url' => method_exists($this, 'getTableRowUrl') ? $this->getTableRowUrl($row) : '','target' => method_exists($this, 'getTableRowUrlTarget') ? $this->getTableRowUrlTarget($row) : '_self','class' => method_exists($this, 'setTableRowClass') ? ' ' . $this->setTableRowClass($row) : '','id' => method_exists($this, 'setTableRowId') ? $this->setTableRowId($row) : '','customAttributes' => method_exists($this, 'setTableRowAttributes') ? $this->setTableRowAttributes($row) : []]]); ?>
<?php $component->withName('livewire-tables::bs4.table.row'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['wire:loading.class.delay' => 'text-muted','wire:key' => 'table-row-'.e(md5(mt_rand())).'-'.e($row->{$this->parseField($primaryKey)}).'','wire:sortable.item' => ''.e($row->{$primaryKey}).'','reordering' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($reordering),'url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(method_exists($this, 'getTableRowUrl') ? $this->getTableRowUrl($row) : ''),'target' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(method_exists($this, 'getTableRowUrlTarget') ? $this->getTableRowUrlTarget($row) : '_self'),'class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(method_exists($this, 'setTableRowClass') ? ' ' . $this->setTableRowClass($row) : ''),'id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(method_exists($this, 'setTableRowId') ? $this->setTableRowId($row) : ''),'customAttributes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(method_exists($this, 'setTableRowAttributes') ? $this->setTableRowAttributes($row) : [])]); ?>
                <?php if($reordering): ?>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /var/www/mykios/vendor/rappasoft/laravel-livewire-tables/src/../resources/views/bootstrap-4/includes/table.blade.php ENDPATH**/ ?>